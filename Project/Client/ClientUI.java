...
public class ClientUI extends JFrame implements IConnectionEvents, IMessageEvents, IRoomEvents, ICardControls {
    ...
    private JLabel countdownLabel = new JLabel("Time Left: 10");
    ...
    public ClientUI(String title) {
        ...
        topBar.add(countdownLabel, BorderLayout.EAST);
    ...
    /**
     * Simple round countdown timer for the UI round label.
     * Karen Ralda // kar65 // Dec 2025
     */
    private void startRoundCountdown() {
        countdownSeconds = 10; // reset to 10 seconds for a round demo
        countdownLabel.setText("Time Left: " + countdownSeconds);
        ...
        countdownTimer = new javax.swing.Timer(1000, e -> {
            ...
            if (countdownSeconds <= 0) {
                countdownTimer.stop();
                countdownLabel.setText("Round Over");
            }
        });
...
//Karen Ralda //Kar65 //December102025
    @Override
    ...
    public void onReceiveClientId(long id) {
        ...
        // Start the countdown when the game screen is shown
        startRoundCountdown();
    }
